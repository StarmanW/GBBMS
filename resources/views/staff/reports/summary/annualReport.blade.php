                ...
                <div class="table-backpanel">
                    <div class="table-wrapper">
                        ...
                        <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">
                            <span style="text-align: center"><a href="./exception/summary/print" target="_blank"><button type="button" class="btn btn-sm btn-primary">Print Report</button></a></span>
                                ...
                                @elseif(session('rType') === "blood")
                                    ...
                                    @foreach($records as $key => $blood)
                                        <tr>
                                            ...
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 1)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 2)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 3)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 4)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 5)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 6)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 7)->get())}} bag(s)</td>
                                            <td class="body-item mbr-fonts-style display-7">{{count($blood->donors->leftJoin('blood', 'blood.donorID', '=', 'donors.donorID')->where('donors.bloodType', '=', 8)->get())}} bag(s)</td>
                                        </tr>
                                    @endforeach
                                @endif
                                </tbody>
