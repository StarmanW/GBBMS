...
@section('contents')
    ...
    <div class="w3-sidebar w3-bar-block w3-animate-left" style="display:none;z-index:5" id="mySidebar">
        ...
        <a href="/staff/hr/report/exception" class="w3-bar-item w3-button">Annual Report</a>
        <a href="/staff/hr/report/exception" class="w3-bar-item w3-button">Monthly Report</a>
                ...
                <div class="table-backpanel">
                    <div class="table-wrapper">
                        ...
                        <h2 class="mbr-section-title mbr-fonts-style align-center pb-3 display-2">
                            <span style="text-align: center"><a href="./{{$resvs[0]->eventID}}/print"><button type="button" class="btn btn-sm btn-primary">Print Report</button></a></span>
                            <span style="text-align: center"><a href=""><button type="button" class="btn btn-sm btn-primary">Back to Search</button></a></span>
                        </h2>
                        <div class="container">
