...
@section('title')
    Blood Management for {{session('eventID')}}
@endsection
                ...
                <div class="mbr-white col-md-10">
                    <div class="container align-center">
                        ...
                        <div class="form-container">
                            <h1 class="well mbr-section-title mbr-fonts-style align-center pb-3 display-2">Blood Management for {{session('eventID')}}</h1>
