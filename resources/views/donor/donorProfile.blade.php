                            ...
                            <div class="col-sm-12">
                                ...
                                <div class="row">
                                    <div class="col-sm-6 form-group">
                                        ...
                                        <input type="radio" name="gender" required="required" value="1" @if($donor->gender === 1) {{'checked="checked"'}} @else {{'checked="checked"'}} @endif>&nbsp;&nbsp;Male&nbsp;&nbsp;
        ...
        <div class="modal fade" id="changePasswordForm" tabindex="-1" role="dialog" aria-labelledby="modalLabel" aria-hidden="true">
            <div class="modal-dialog modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST" action="/donor/profile/password" enctype="multipart/form-data">
                            {{csrf_field()}}
                            <p style="color:red; float: left;">"*" Required fields</p>
                            <br />
                            <br />
    ...
    @if(count($errors) > 0)
        @if(session('passValidation'))
            <script>
                ...
                donorFormError('Change Password', {!! $errors !!});
            </script>
